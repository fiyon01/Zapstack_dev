...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, ChevronRight, Github, Key, Zap, Rocket, Cpu, Code, Database, Server, Wifi, Cctv } from 'lucide-react';
      ...
      toast.success(
        <div>
          ...
          <div className="mt-2 p-2 bg-gray-800 rounded-md text-xs font-mono">
            <span className="text-gray-400">Your token: </span>
